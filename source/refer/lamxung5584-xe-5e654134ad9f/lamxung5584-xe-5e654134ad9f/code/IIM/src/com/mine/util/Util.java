...
public class Util {
	...
	public static boolean checkPassword(String host, int port, String user, String pass, String shell){
    	NewJSchSshUtil sshUtil = new NewJSchSshUtil(host, port, user, pass, shell);
