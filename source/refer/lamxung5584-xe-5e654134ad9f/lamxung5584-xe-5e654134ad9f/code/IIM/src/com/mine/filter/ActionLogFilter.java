...
//                try {
//                    FacesContext context = getFacesContext(hRequest, hResponse);
////                    Bean bean = context.getApplication().evaluateExpressionGet(context, "#{serverNewController}", Bean.class);
//                    UICommand uICommand = findInvokedCommandComponent(context);
//                    if (uICommand != null) {
